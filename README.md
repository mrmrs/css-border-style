...
Functional CSS for border-style

## Filesize

| File | Size |
|------|------|
| `dist/border-style.css` | 9993 bytes |
| `dist/border-style.min.css` | 7279 bytes (931 Gzipped) |

## Install

```sh
npm install css-border-style
```
...
```html
<link rel="stylesheet" href="https://unpkg.com/css-border-style/dist/border-style.min.css">
```

### Direct

```html
<link rel="stylesheet" href="path/to/css-border-style/dist/border-style.min.css">
```
...
| `.ba-none-s` | `border-style: none;` |
| `.ba-hidden-s` | `border-style: hidden;` |
| `.ba-dotted-s` | `border-style: dotted;` |
| `.ba-dashed-s` | `border-style: dashed;` |
| `.ba-solid-s` | `border-style: solid;` |
| `.ba-double-s` | `border-style: double;` |
| `.ba-groove-s` | `border-style: groove;` |
| `.ba-ridge-s` | `border-style: ridge;` |
| `.ba-inset-s` | `border-style: inset;` |
| `.ba-outset-s` | `border-style: outset;` |
| `.bt-none-s` | `border-top-style: none;` |
| `.bt-hidden-s` | `border-top-style: hidden;` |
| `.bt-dotted-s` | `border-top-style: dotted;` |
| `.bt-dashed-s` | `border-top-style: dashed;` |
| `.bt-solid-s` | `border-top-style: solid;` |
| `.bt-double-s` | `border-top-style: double;` |
| `.bt-groove-s` | `border-top-style: groove;` |
| `.bt-ridge-s` | `border-top-style: ridge;` |
| `.bt-inset-s` | `border-top-style: inset;` |
| `.bt-outset-s` | `border-top-style: outset;` |
| `.bb-none-s` | `border-bottom-style: none;` |
| `.bb-hidden-s` | `border-bottom-style: hidden;` |
| `.bb-dotted-s` | `border-bottom-style: dotted;` |
| `.bb-dashed-s` | `border-bottom-style: dashed;` |
| `.bb-solid-s` | `border-bottom-style: solid;` |
| `.bb-double-s` | `border-bottom-style: double;` |
| `.bb-groove-s` | `border-bottom-style: groove;` |
| `.bb-ridge-s` | `border-bottom-style: ridge;` |
| `.bb-inset-s` | `border-bottom-style: inset;` |
| `.bb-outset-s` | `border-bottom-style: outset;` |
| `.bl-none-s` | `border-left-style: none;` |
| `.bl-hidden-s` | `border-left-style: hidden;` |
| `.bl-dotted-s` | `border-left-style: dotted;` |
| `.bl-dashed-s` | `border-left-style: dashed;` |
| `.bl-solid-s` | `border-left-style: solid;` |
| `.bl-double-s` | `border-left-style: double;` |
| `.bl-groove-s` | `border-left-style: groove;` |
| `.bl-ridge-s` | `border-left-style: ridge;` |
| `.bl-inset-s` | `border-left-style: inset;` |
| `.bl-outset-s` | `border-left-style: outset;` |
| `.br-none-s` | `border-right-style: none;` |
| `.br-hidden-s` | `border-right-style: hidden;` |
| `.br-dotted-s` | `border-right-style: dotted;` |
| `.br-dashed-s` | `border-right-style: dashed;` |
| `.br-solid-s` | `border-right-style: solid;` |
| `.br-double-s` | `border-right-style: double;` |
| `.br-groove-s` | `border-right-style: groove;` |
| `.br-ridge-s` | `border-right-style: ridge;` |
| `.br-inset-s` | `border-right-style: inset;` |
| `.br-outset-s` | `border-right-style: outset;` |
...
Example: `.ba-none-m` applies the property at the medium breakpoint and above.
...
Processes `src/border-style.css` with [Lightning CSS](https://lightningcss.dev) and outputs to `dist/`.

- `dist/border-style.css` — formatted
- `dist/border-style.min.css` — minified
