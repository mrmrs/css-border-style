...
ssh:
```
git clone git@github.com:tachyons-css/css-border-style.git
```
...
```
<link rel="stylesheet" href="http://unpkg.com/css-border-style@1.0.6/css/css-border-style.min.css" />
```
